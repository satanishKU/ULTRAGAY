	...
	if (!message.member.permissions.has("ADMINISTRATOR")) {
		...
		if (!name) {
			...
			if (dq == 0) {
		    	let exampleEmbed = new MessageEmbed()
					.setColor(0x2f3136)
					.setDescription('**<:locked:1001383615625695292> Ой! Извините, но, похоже, такой вакансии нет!**')
			...
			try {
				...
				connect.work.splice(s, 1)
				client.save()
		    	let exampleEmbed = new MessageEmbed()
					.setColor(0x00ffff)
					.setDescription('**<:shop:962773822656872508> Вакансия была успешно удалена из вашего магазина!**')
